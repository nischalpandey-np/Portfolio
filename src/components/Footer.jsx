...
const Logo = () => (
  <div className="flex items-center gap-3">
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M2 24V2H7L18 18.5V2H23V24H18L7 7.5V24H2Z" fill="url(#logo-grad)"/>
      <defs>
        <linearGradient id="logo-grad" x1="2" y1="2" x2="23" y2="24" gradientUnits="userSpaceOnUse">
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col gap-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="max-w-xs text-sm text-gray-500 dark:text-gray-500 font-medium leading-relaxed">
                Building digital products that are fast, reliable, and thoughtfully designed. From Kathmandu to the world.
              </p>
              <NepalClock />
            </div>
            ...
            <div className="flex flex-col gap-3">
              <p className="text-xs font-black uppercase tracking-[0.25em] text-gray-300 dark:text-gray-700 mb-1">Navigation</p>
              {[
            ...
            {/* Socials */}
            <div className="flex flex-col gap-3">
              <p className="text-xs font-black uppercase tracking-[0.25em] text-gray-300 dark:text-gray-700 mb-1">Connect</p>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-gray-200 dark:border-gray-900">
            ...
            >
              Back to top
              <span className="group-hover:-translate-y-1 transition-transform duration-200 inline-block">↑</span>
            </motion.button>
          </div>
        </div>
      </motion.footer>
