...
const workData = [
  ...
  },
  {
    ...
    tech: "React · TanStack · Framer",
    color: "#22d3ee",
    image: "/hospital_project.jpg",
  },
  {
    title: "FusionDot Consultancy",
    role: "Frontend Developer",
    tech: "React · Leaflet · Router",
    color: "#f59e0b",
...
export const IdleScreen = () => (
  ...
  >
      ...
      {[1, 2, 3, 4, 5].map((i) => (
        <div
          ...
          style={{
            ...
            opacity: 0.5 + i * 0.1,
            borderRadius: 2,
            animation: `bp ${0.5 + i * 0.12}s ease-in-out infinite alternate`,
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <div
        style={{
          fontSize: "clamp(9px,1.1cqw,12px)",
          color: "rgba(255,255,255,0.35)",
          letterSpacing: 3,
          fontFamily: "'Courier New',monospace",
        }}
      >
        ▸ scroll or click a channel to tune in
      </div>
    </div>
...
const AboutChannel = () => (
  ...
  >
    <div style={{ width: "36%", flexShrink: 0, position: "relative" }}>
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "linear-gradient(to right,transparent 55%,#07070f 100%)",
        }}
      />
    </div>
    <div
    ...
    >
      ...
      <div
        style={{
          fontSize: "clamp(11px,1.4cqw,15px)",
          color: "#4f8ef7",
          fontWeight: 500,
          marginBottom: 16,
        }}
      ...
      <p
        style={{
          margin: "0 0 20px",
          fontSize: "clamp(10px,1.2cqw,13px)",
          color: "#a1a1aa",
          lineHeight: 1.7,
        }}
      >
        I build fast, scalable web applications using the MERN stack. Focused on
        clean code, great UX, and systems that actually scale.
      </p>
          ...
          {workData.map((p, i) => (
            <div
              ...
              style={{
                ...
                borderLeft:
                  i === sel ? "3px solid #4f8ef7" : "3px solid transparent",
            ...
            >
              ...
              <div
                style={{
                  fontSize: "clamp(8px,0.9cqw,10px)",
                  color: i === sel ? "#4f8ef7" : "#52525b",
                }}
              >
                {p.role}
              </div>
          ...
          <div style={{ flex: 1, position: "relative", overflow: "hidden" }}>
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to top,rgba(7,7,15,0.95) 0%,rgba(7,7,15,0.2) 100%)",
              }}
            />
          </div>
          <div
...
const SkillsChannel = () => (
  ...
  >
    ...
    >
      <div
        style={{
          fontSize: "clamp(13px,1.8cqw,20px)",
          fontWeight: 300,
          color: "#fff",
          marginBottom: 16,
          letterSpacing: "-0.3px",
      ...
      >
        <div
          style={{
            fontSize: "clamp(8px,0.9cqw,11px)",
            color: "#00ff88",
            letterSpacing: 0.5,
          }}
        >
          🔭 Exploring: Docker · AWS · Redis · GraphQL · tRPC
        </div>
      </div>
    </div>
  </div>
    ...
    >
      <div
        style={{
          ...
          width: 1,
          background:
            "linear-gradient(to bottom,#4f8ef7,rgba(79,142,247,0.08))",
        }}
      />
      {[
        {
          ...
          org: "Rahu Doom Pvt Ltd",
          period: "May 2026 – Present",
          desc: "Architecting scalable frontends, optimizing performance, delivering exceptional UX for production web apps.",
        },
        {
          dot: "rgba(255,255,255,0.25)",
          title: "B.Sc. CSIT",
          org: "Metropolitan College, Kathmandu",
          period: "2025 – Present",
          desc: "Computer Science & IT. Studying DSA, DBMS, OS, Web Technologies, and OOP.",
        },
      ].map((e, i) => (
        <div
          key={i}
        ...
        >
          <div
            style={{
              ...
              marginTop: 4,
              flexShrink: 0,
              marginLeft: "clamp(5px,0.8cqw,9px)",
            }}
          />
          <div style={{ flex: 1 }}>
            <div
              style={{
                fontSize: "clamp(12px,1.5cqw,17px)",
                fontWeight: 600,
                color: "#fff",
                marginBottom: 2,
              }}
    ...
    >
      <div style={{ width: "100%", maxWidth: 380 }}>
        <h2
          style={{
            margin: "0 0 6px",
            fontSize: "clamp(18px,2.2cqw,28px)",
            fontWeight: 700,
            color: "#fff",
            letterSpacing: "-0.5px",
          }}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <a
            href="mailto:fsd.nischal@gmail.com"
            style={{
              display: "flex",
              alignItems: "center",
              ...
              textDecoration: "none",
              fontWeight: 600,
              fontSize: "clamp(9px,1.1cqw,13px)",
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {[
              { l: "GitHub", u: "https://github.com/nischalpandey-np" },
              { l: "LinkedIn", u: "https://linkedin.com/in/nischal-pandey-np" },
            ].map((x) => (
              <a
                key={x.l}
                href={x.u}
...
const TVShell = () => (
  ...
  >
    ...
    <g stroke="#c49030" strokeWidth="1.8" strokeLinecap="round">
      {[257, 261, 265, 269, 273, 277, 281].map((x) => (
        <line key={x} x1={x} y1="108" x2={x} y2="142" />
      ))}
    </g>
    <rect
      x="253"
  ...
  >
    <div
      style={{
        ...
        background: "#fff",
        boxShadow:
          "0 0 14px 5px rgba(255,255,255,0.9), 0 0 40px 10px rgba(180,200,255,0.4)",
...
const TVStage = ({ activeChannel, onChannelChange, tvOn, onTvToggle }) => {
  ...
  let Ch = IdleScreen,
    chLabel = null;
  if (activeChannel === "minesweeper") {
    Ch = Minesweeper;
    chLabel = "CH G1 · MINESWEEPER";
  } else if (activeChannel === "snake") {
    Ch = SnakeGame;
    chLabel = "CH G2 · SNAKE";
  } else if (typeof activeChannel === "number" && CHANNELS[activeChannel]) {
    Ch = CHANNELS[activeChannel].component;
    chLabel = `CH ${CHANNELS[activeChannel].num} · ${CHANNELS[
      activeChannel
    ].name.toUpperCase()}`;
  }
    ...
    >
      ...
      <div ref={tvRef} style={{ position: "relative", width: "100%" }}>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!isMobile)
              e.currentTarget.style.transform = "translateY(-50%) scale(1.13)";
          }}
          onMouseLeave={(e) => {
            if (!isMobile)
        ...
        >
          ...
          {chLabel && !isSwitching && bootPhase === "on" && (
            ...
            >
              <div
                style={{
                  fontSize: "clamp(7px,0.9cqw,11px)",
                  color: "#00ff88",
                  fontFamily: "'Courier New',monospace",
                  letterSpacing: 2,
          ...
          <div
            style={{
              ...
              zIndex: 20,
              background:
                "radial-gradient(ellipse at center,transparent 62%,rgba(0,0,0,0.6) 100%)",
            }}
          />
          {/* Scanlines */}
          <div
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: "1px solid",
                  borderColor: on ? "#fff" : "rgba(255,255,255,0.1)",
                  borderRadius: 100,
                  color: on ? "#0a0a0f" : "rgba(255,255,255,0.45)",
